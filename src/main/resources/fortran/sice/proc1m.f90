program proc1
    ...
    real xa(168), ya(168)
    EXTERNAL fun1, fun2
    COMMON as, bs, cs, am1, am2, r400, r865, r1020, BBB, NSOLO,
    c****************************************************************
    c          ALEX
    c        thv, xa, ya
...
c+++++++++++++++++++++++++++++++++++++++++++++ =
        ...
        real function fun1(x)
                c            Alex
                real bbb(9, 6), a(6), xa(168), ya(168), dif(168)
                integer kss(2)
        common as, bs, cs, csza,cvza, r400, r865, r1020, bbb,NSOLO,
        c****************************************************
                c     thv, xa, ya
                c     ALEX
                ks = 1
        ...
        funcs= p0+p1*exp(-x/t1)+p2*exp(-x/t2)
                ...
                fun1 = f1*funcs
                c      write(*, *) r400, x, f1, funcs, rsd,x, astra, nsolo
                return
                END
